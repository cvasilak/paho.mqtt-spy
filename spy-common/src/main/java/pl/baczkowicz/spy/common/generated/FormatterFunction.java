...
public class FormatterFunction implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "conversion", buffer, theConversion, (this.conversion!= null));
        }
        {
            SubstringConversionFormatterDetails theSubstringConversion;
            theSubstringConversion = this.getSubstringConversion();
            strategy.appendField(locator, this, "substringConversion", buffer, theSubstringConversion, (this.substringConversion!= null));
        }
        {
            SubstringReplaceFormatterDetails theSubstringReplace;
            theSubstringReplace = this.getSubstringReplace();
            strategy.appendField(locator, this, "substringReplace", buffer, theSubstringReplace, (this.substringReplace!= null));
        }
        {
            SubstringExtractFormatterDetails theSubstringExtract;
            theSubstringExtract = this.getSubstringExtract();
            strategy.appendField(locator, this, "substringExtract", buffer, theSubstringExtract, (this.substringExtract!= null));
        }
        {
            CharacterReplaceFormatterDetails theCharacterReplace;
            theCharacterReplace = this.getCharacterReplace();
            strategy.appendField(locator, this, "characterReplace", buffer, theCharacterReplace, (this.characterReplace!= null));
        }
        {
            ScriptExecutionDetails theScriptExecution;
            theScriptExecution = this.getScriptExecution();
            strategy.appendField(locator, this, "scriptExecution", buffer, theScriptExecution, (this.scriptExecution!= null));
        }
        return buffer;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final FormatterFunction that = ((FormatterFunction) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "conversion", lhsConversion), LocatorUtils.property(thatLocator, "conversion", rhsConversion), lhsConversion, rhsConversion, (this.conversion!= null), (that.conversion!= null))) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "substringConversion", lhsSubstringConversion), LocatorUtils.property(thatLocator, "substringConversion", rhsSubstringConversion), lhsSubstringConversion, rhsSubstringConversion, (this.substringConversion!= null), (that.substringConversion!= null))) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "substringReplace", lhsSubstringReplace), LocatorUtils.property(thatLocator, "substringReplace", rhsSubstringReplace), lhsSubstringReplace, rhsSubstringReplace, (this.substringReplace!= null), (that.substringReplace!= null))) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "substringExtract", lhsSubstringExtract), LocatorUtils.property(thatLocator, "substringExtract", rhsSubstringExtract), lhsSubstringExtract, rhsSubstringExtract, (this.substringExtract!= null), (that.substringExtract!= null))) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "characterReplace", lhsCharacterReplace), LocatorUtils.property(thatLocator, "characterReplace", rhsCharacterReplace), lhsCharacterReplace, rhsCharacterReplace, (this.characterReplace!= null), (that.characterReplace!= null))) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "scriptExecution", lhsScriptExecution), LocatorUtils.property(thatLocator, "scriptExecution", rhsScriptExecution), lhsScriptExecution, rhsScriptExecution, (this.scriptExecution!= null), (that.scriptExecution!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            ConversionFormatterDetails theConversion;
            theConversion = this.getConversion();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "conversion", theConversion), currentHashCode, theConversion, (this.conversion!= null));
        }
        {
            SubstringConversionFormatterDetails theSubstringConversion;
            theSubstringConversion = this.getSubstringConversion();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "substringConversion", theSubstringConversion), currentHashCode, theSubstringConversion, (this.substringConversion!= null));
        }
        {
            SubstringReplaceFormatterDetails theSubstringReplace;
            theSubstringReplace = this.getSubstringReplace();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "substringReplace", theSubstringReplace), currentHashCode, theSubstringReplace, (this.substringReplace!= null));
        }
        {
            SubstringExtractFormatterDetails theSubstringExtract;
            theSubstringExtract = this.getSubstringExtract();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "substringExtract", theSubstringExtract), currentHashCode, theSubstringExtract, (this.substringExtract!= null));
        }
        {
            CharacterReplaceFormatterDetails theCharacterReplace;
            theCharacterReplace = this.getCharacterReplace();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "characterReplace", theCharacterReplace), currentHashCode, theCharacterReplace, (this.characterReplace!= null));
        }
        {
            ScriptExecutionDetails theScriptExecution;
            theScriptExecution = this.getScriptExecution();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "scriptExecution", theScriptExecution), currentHashCode, theScriptExecution, (this.scriptExecution!= null));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof FormatterFunction) {
            ...
            {
                Boolean conversionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.conversion!= null));
                if (conversionShouldBeCopiedAndSet == Boolean.TRUE) {
                    ConversionFormatterDetails sourceConversion;
                    sourceConversion = this.getConversion();
                    ConversionFormatterDetails copyConversion = ((ConversionFormatterDetails) strategy.copy(LocatorUtils.property(locator, "conversion", sourceConversion), sourceConversion, (this.conversion!= null)));
                    copy.setConversion(copyConversion);
                } else {
                    if (conversionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.conversion = null;
                    }
                }
            }
            {
                Boolean substringConversionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.substringConversion!= null));
                if (substringConversionShouldBeCopiedAndSet == Boolean.TRUE) {
                    SubstringConversionFormatterDetails sourceSubstringConversion;
                    sourceSubstringConversion = this.getSubstringConversion();
                    SubstringConversionFormatterDetails copySubstringConversion = ((SubstringConversionFormatterDetails) strategy.copy(LocatorUtils.property(locator, "substringConversion", sourceSubstringConversion), sourceSubstringConversion, (this.substringConversion!= null)));
                    copy.setSubstringConversion(copySubstringConversion);
                } else {
                    if (substringConversionShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.substringConversion = null;
                    }
                }
            }
            {
                Boolean substringReplaceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.substringReplace!= null));
                if (substringReplaceShouldBeCopiedAndSet == Boolean.TRUE) {
                    SubstringReplaceFormatterDetails sourceSubstringReplace;
                    sourceSubstringReplace = this.getSubstringReplace();
                    SubstringReplaceFormatterDetails copySubstringReplace = ((SubstringReplaceFormatterDetails) strategy.copy(LocatorUtils.property(locator, "substringReplace", sourceSubstringReplace), sourceSubstringReplace, (this.substringReplace!= null)));
                    copy.setSubstringReplace(copySubstringReplace);
                } else {
                    if (substringReplaceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.substringReplace = null;
                    }
                }
            }
            {
                Boolean substringExtractShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.substringExtract!= null));
                if (substringExtractShouldBeCopiedAndSet == Boolean.TRUE) {
                    SubstringExtractFormatterDetails sourceSubstringExtract;
                    sourceSubstringExtract = this.getSubstringExtract();
                    SubstringExtractFormatterDetails copySubstringExtract = ((SubstringExtractFormatterDetails) strategy.copy(LocatorUtils.property(locator, "substringExtract", sourceSubstringExtract), sourceSubstringExtract, (this.substringExtract!= null)));
                    copy.setSubstringExtract(copySubstringExtract);
                } else {
                    if (substringExtractShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.substringExtract = null;
                    }
                }
            }
            {
                Boolean characterReplaceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.characterReplace!= null));
                if (characterReplaceShouldBeCopiedAndSet == Boolean.TRUE) {
                    CharacterReplaceFormatterDetails sourceCharacterReplace;
                    sourceCharacterReplace = this.getCharacterReplace();
                    CharacterReplaceFormatterDetails copyCharacterReplace = ((CharacterReplaceFormatterDetails) strategy.copy(LocatorUtils.property(locator, "characterReplace", sourceCharacterReplace), sourceCharacterReplace, (this.characterReplace!= null)));
                    copy.setCharacterReplace(copyCharacterReplace);
                } else {
                    if (characterReplaceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.characterReplace = null;
                    }
                }
            }
            {
                Boolean scriptExecutionShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.scriptExecution!= null));
                if (scriptExecutionShouldBeCopiedAndSet == Boolean.TRUE) {
                    ScriptExecutionDetails sourceScriptExecution;
                    sourceScriptExecution = this.getScriptExecution();
                    ScriptExecutionDetails copyScriptExecution = ((ScriptExecutionDetails) strategy.copy(LocatorUtils.property(locator, "scriptExecution", sourceScriptExecution), sourceScriptExecution, (this.scriptExecution!= null)));
                    copy.setScriptExecution(copyScriptExecution);
                } else {
                    if (scriptExecutionShouldBeCopiedAndSet == Boolean.FALSE) {
