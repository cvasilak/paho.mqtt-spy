    ...
    implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        super.appendFields(locator, buffer, strategy);
        {
            ...
            strategy.appendField(locator, this, "replaceWith", buffer, theReplaceWith, (this.replaceWith!= null));
        }
        return buffer;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SubstringReplaceFormatterDetails that = ((SubstringReplaceFormatterDetails) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "replaceWith", lhsReplaceWith), LocatorUtils.property(thatLocator, "replaceWith", rhsReplaceWith), lhsReplaceWith, rhsReplaceWith, (this.replaceWith!= null), (that.replaceWith!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            String theReplaceWith;
            theReplaceWith = this.getReplaceWith();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "replaceWith", theReplaceWith), currentHashCode, theReplaceWith, (this.replaceWith!= null));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SubstringReplaceFormatterDetails) {
            ...
            {
                Boolean replaceWithShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.replaceWith!= null));
                if (replaceWithShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceReplaceWith;
                    sourceReplaceWith = this.getReplaceWith();
                    String copyReplaceWith = ((String) strategy.copy(LocatorUtils.property(locator, "replaceWith", sourceReplaceWith), sourceReplaceWith, (this.replaceWith!= null)));
                    copy.setReplaceWith(copyReplaceWith);
                } else {
                    if (replaceWithShouldBeCopiedAndSet == Boolean.FALSE) {
